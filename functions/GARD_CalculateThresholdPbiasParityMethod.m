function [a_out_H,a_out_V, lambda_out_H, lambda_out_V] = GARD_CalculateThresholdPbiasParityMethod(P_fa,P_md_H,P_md_V,DOFrange)
...
a_V = chi2inv(1-P_fa,DOFrange);   %added ./DOFrange as this is how the threshold is calculated in normalised SS method 29.1.08
TD_V = sqrt(a_V);
