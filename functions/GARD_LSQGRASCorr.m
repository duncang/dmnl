function [SolutionVec, VarSolutionVec, NumIterations, ResidualVector, M, LSQ_Fail, limit, DOP] = GARD_LSQGRASCorr(UserPos,N,PRMeasured,SVPos);
...
%
% $Id: GARD_LSQGRASCorr.m 1850 2008-07-14 04:52:47Z greerd $
%
...
%UserPos is the true surveyed position of the receiver. 
...
%     TempBase_B_Pos(4) = TempBase_B_Pos(4) + Delta_X(4);
 ...
 TempBase_B_Pos(1) = TempBase_B_Pos(1) ;
    TempBase_B_Pos(2) = TempBase_B_Pos(2) ;
    TempBase_B_Pos(3) = TempBase_B_Pos(3) ;
    TempBase_B_Pos(4) = TempBase_B_Pos(4) + Delta_X(4);
