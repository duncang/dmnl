...
function model = init(init_args)
  ...
  model.tag  = 'GARDSim_GPSINS';                           % ID tag
  ...
  model.statedim   = 18;                      % state dimension
  model.obsdim     = 16;                      % observation dimension
  model.paramdim   = 0;                      % total parameter dimension
  model.U1dim      = 8;                      % exogenous control input 1 dimension
  model.U2dim      = 0;                      % exogenous control input 2 dimension
  model.Vdim       = 8;                      % process noise dimension
  model.Ndim       = 16;                      % observation noise dimension
