...
% save data path
dtg = clock;
ukf_results_filename = strcat(DataPath,'ukf_results_');
...
StartTime = TruthOffset+1; % start at 60 seconds into the data set
...
y_accel_beta = 1/300;
z_accel_beta = 1/300;
x_gyro_Q = 0.0552; % PSD of gyro noise
y_gyro_Q = 0.0552; % PSD of gyro noise
z_gyro_Q = 0.0552; % PSD of gyro noise
...
if Sim_Data == 1                
        ...
        UKF_y_k = [PR_Vec(1:8)';PRR_Vec(1:8)'];
...
if FDEnabled == 1
        ...
        for SubSolution = 1:NumberSubFilters
            ...
            [UKF_y_hat_kminus_Sub,UKF_Py_kminus_Sub,UKF_Pxy_kminus_Sub] = GARD_GenerateMeasurementMeanFromSigmaPoints(xs,ys_Sub,Ws,NumberStates,NumberSubMeasurements);
            ...
            UKF_x_hat_kplus_Sub(:,SubSolution) = UKF_x_hat_kminus + UKF_K_k_Sub * UKF_z_Sub;

            UKF_Px_kplus_Sub(:,:,SubSolution) = UKF_Px_kminus - UKF_K_k_Sub * UKF_Py_kminus_Sub * UKF_K_k_Sub';
