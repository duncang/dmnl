...
Q(10,10) = 2*in.x_accel_beta*in.x_accel_Q;
Q(11,11) = 2*in.y_accel_beta*in.y_accel_Q;
Q(12,12) = 2*in.z_accel_beta*in.z_accel_Q;
Q(13,13) = 2*in.x_gyro_beta*in.x_gyro_Q;
Q(14,14) = 2*in.y_gyro_beta*in.y_gyro_Q;
Q(15,15) = 2*in.z_gyro_beta*in.z_gyro_Q;
