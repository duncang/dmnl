%This is for verifying that HPL and VPL meet Pmd statistics
%24 November 2008
...
Nmc = 3;   %83 runs is the maximum without getting an out of memory error
...
montecarlo_geometry = 0;  %don't do geometry simulation, i have this is a separate file
...
save('MonteCarloData.mat');   %at end, save all variables in workspace in current directory
...
%code here to find which ones are the largest so i can see why
