...
CD0 = CDmin;   %Reference Drag coefficient, from aerosim
CLD0 = CLmind; %i think this is the correct parameter
k = 1/(pi*AR*osw);
...
ParametersTruth(1) =  CD0;
ParametersTruth(2) =  k; %delta k is zero
ParametersTruth(3) =  CYbeta;
ParametersTruth(4) =  CYdr;
ParametersTruth(5) =  CL0;
ParametersTruth(6) =  CLa;
ParametersTruth(7) =  CLde;
ParametersTruth(8) =  Cm0;
ParametersTruth(9) =  Cma;
ParametersTruth(10) =  Cmq;
ParametersTruth(11) =  Cmde;
ParametersTruth(12) =  Cnbeta;
ParametersTruth(13) =  Cnda;
ParametersTruth(14) =  Cndr;
ParametersTruth(15) =  Cnp;
ParametersTruth(16) =  Cnr;
ParametersTruth(17) =  Clbeta;
ParametersTruth(18) =  Clda;
ParametersTruth(19) =  Cldr;
ParametersTruth(20) = Clp;
ParametersTruth(21) = Clr;
